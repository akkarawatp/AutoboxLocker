<%@ Page Title="" Language="vb" AutoEventWireup="true" MasterPageFile="~/Master/MasterPage.Master"  CodeFile="Report_SummaryBySize.aspx.vb" Inherits="Report_SummaryBySize" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="page-title">
        <div class="title">Reports > Summary Report > By  Locker Size</div>
    </div>
                      ...
                      <asp:Repeater ID="rptList" runat="server">
                        <ItemTemplate>
                            <tr>                 
                                ...
                                <td data-title="Product" class="center"><asp:Label ID="lblProductSize" runat="server"></asp:Label></td>
                                <td data-title="ServiceTime" class="center"><asp:Label ID="lblServiceTime" runat="server"></asp:Label></td>
                                <td data-title="Transaction"><asp:Label ID="lblTransQty" runat="server"></asp:Label></td>
                                <td data-title="WaitingCollect"><asp:Label ID="lblWaitingCollect" runat="server"></asp:Label></td>
                                ...
                                <td data-title="SalesValue"><asp:Label ID="lblSalesValue" runat="server"></asp:Label></td>
                                <td data-title="DepositAmt"><asp:Label ID="lblDepositAmount" runat="server"></asp:Label></td>
                            </tr>
                         </ItemTemplate>                          
                      </asp:Repeater>  
                    <tr>
                        <td data-title="Average" colspan="2" style="background-color:#eeeeee; font-weight:bold;">Average</td>
                        <td data-title="ServiceTime" class="bold bg-default-light"><asp:Label ID="lbl_AVG_Service_Time" runat="server"></asp:Label></td>
                        <td data-title="Transaction" class="bold bg-default-light"><asp:Label ID="lbl_AVG_Transaction" runat="server"></asp:Label></td>
                        <td data-title="WaitingCollect" class="bold bg-default-light"><asp:Label ID="lbl_AVG_WaitingCollect" runat="server"></asp:Label></td>
                        ...
                        <td data-title="SalesValue" class="bold bg-default-light"><asp:Label ID="lbl_AVG_Sales_Value" runat="server"></asp:Label></td>
                        <td data-title="DepositAmt" class="bold bg-default-light"><asp:Label ID="lbl_AVG_Deposit_Amount" runat="server"></asp:Label></td>
                    </tr>     
                    <tr>
                        <td data-title="Total" colspan="2" class="bold bg-default-light">Total</td>
                        <td data-title="ServiceTime" class="bold bg-default-light"><asp:Label ID="lbl_SUM_Service_Time" runat="server"></asp:Label></td>
                        <td data-title="Transaction" class="bold bg-default-light"><asp:Label ID="lbl_SUM_Transaction" runat="server"></asp:Label></td>
                        <td data-title="WaitingCollect" class="bold bg-default-light"><asp:Label ID="lbl_SUM_WaitingCollect" runat="server"></asp:Label></td>
                        ...
                        <td data-title="SalesValue" class="bold bg-default-light"><asp:Label ID="lbl_SUM_Sales_Value" runat="server"></asp:Label></td> 
                        <td data-title="DepositAmt" class="bold bg-default-light"><asp:Label ID="lbl_SUM_Deposit_Amount" runat="server"></asp:Label></td> 
                    </tr>                                             
                  </tbody>                
                </table>
            </div>
