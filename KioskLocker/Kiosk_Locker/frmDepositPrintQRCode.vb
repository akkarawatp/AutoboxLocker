...
#Region "Print With PrintDocument"
    ...
    Private Sub p_PrintPage(sender As System.Object, e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        Dim fn6b As New Font("Calibri", 6, FontStyle.Bold)
        ...
        PrintText(DepositTime.ToUpper, fn8, e, 50, 50)

        PrintText(Deposit.LockerName, fn15b, e, 50, 70)
        'PrintText(Deposit.LockerName & " ", fn15b, Align.Right, e)

        PrintText(KioskConfig.LocationName, fn8, e, 50, 100)
        'PrintText(KioskConfig.LocationName & " ", fn8, Align.Right, e)

        'Print Barcode
        Dim BarcodeText As String = "*" & Deposit.DepositTransNo & "*"
        ...
        PrintText("Use this slip to take back your luggage", fn6, e, 50, 200)
        PrintText("Warning : This barode can be used only 1 time", fn6, e, 50, 210)
        ...
        PrintText("Tel. " & KioskConfig.ContactCenterTelno & " (in service time)", fn7, Align.Center, e, 265)
