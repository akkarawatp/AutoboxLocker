...
Namespace TABLE
    ...
    Public Class MsLockerKioskLinqDB
        ...
        Public Property ACTIVE_STATUS() As Char
            ...
            End Set
        End Property 
        <Column(Storage:="_MS_LOCKER_ID", DbType:="BigInt NOT NULL ",CanBeNull:=false)>  _
        Public Property MS_LOCKER_ID() As Long
            Get
       ...
       'Define Public Method 
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As MsLockerKioskLinqDB
            Dim p(1) As SQLParameter
            p(0) = DB.SetBigInt("@_ID", cID)
        ...
        '/// Returns an indication whether the record of MS_LOCKER by specified MS_LOCKER_ID key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of MS_LOCKER by specified MS_LOCKER_ID key is retrieved successfully.
        '/// <param name=cMS_LOCKER_ID>The MS_LOCKER_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        Private Function SetParameterData() As SqlParameter()
            ...
            cmbParam(16) = New SqlParameter("@_MS_LOCKER_ID", SqlDbType.BigInt)
            cmbParam(16).Value = _MS_LOCKER_ID

            cmbParam(17) = New SqlParameter("@_SYNC_TO_SERVER", SqlDbType.Char)
            cmbParam(17).Value = _SYNC_TO_SERVER

            cmbParam(18) = New SqlParameter("@_SYNC_TO_KIOSK", SqlDbType.Char)
            cmbParam(18).Value = _SYNC_TO_KIOSK
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction, cmdPara() As SQLParameter) As MsLockerKioskLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (CREATED_BY, CREATED_DATE, LOCKER_NAME, LAYOUT_NAME, MS_KIOSK_ID, MS_CABINET_ID, MODEL_NAME, PIN_SOLENOID, PIN_LED, PIN_SENSOR, OPEN_CLOSE_STATUS, CURRENT_AVAILABLE, ACTIVE_STATUS, MS_LOCKER_ID, SYNC_TO_SERVER, SYNC_TO_KIOSK)"
                Sql += " OUTPUT INSERTED.ID, INSERTED.CREATED_BY, INSERTED.CREATED_DATE, INSERTED.UPDATED_BY, INSERTED.UPDATED_DATE, INSERTED.LOCKER_NAME, INSERTED.LAYOUT_NAME, INSERTED.MS_KIOSK_ID, INSERTED.MS_CABINET_ID, INSERTED.MODEL_NAME, INSERTED.PIN_SOLENOID, INSERTED.PIN_LED, INSERTED.PIN_SENSOR, INSERTED.OPEN_CLOSE_STATUS, INSERTED.CURRENT_AVAILABLE, INSERTED.ACTIVE_STATUS, INSERTED.MS_LOCKER_ID, INSERTED.SYNC_TO_SERVER, INSERTED.SYNC_TO_KIOSK"
                Sql += " VALUES("
                sql += "@_CREATED_BY" & ", "
                sql += "@_CREATED_DATE" & ", "
                sql += "@_LOCKER_NAME" & ", "
        ...
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATED_BY, CREATED_DATE, UPDATED_BY, UPDATED_DATE, LOCKER_NAME, LAYOUT_NAME, MS_KIOSK_ID, MS_CABINET_ID, MODEL_NAME, PIN_SOLENOID, PIN_LED, PIN_SENSOR, OPEN_CLOSE_STATUS, CURRENT_AVAILABLE, ACTIVE_STATUS, MS_LOCKER_ID, SYNC_TO_SERVER, SYNC_TO_KIOSK FROM " & tableName
                Return Sql
            End Get
        End Property
