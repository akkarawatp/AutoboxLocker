...
Namespace ConnectDB
    Public Class KioskTransactionDB
        ...
        Public Function CommitTransaction() As Boolean
            ...
            Catch ex As SqlException
                ret = False
                _error = KioskDB.GetExceptionMessage(ex)
            Catch
                ret = False
        ...
        Public Function CreateTransaction() As Boolean
            ...
            Try
                ...
                If _conn Is Nothing Then _conn = KioskDB.GetConnection
                If _conn IsNot Nothing Then
        ...
        Public Function CreateTransaction(ByVal connectionString As String) As Boolean
            ...
            Try
                If _conn IsNot Nothing Then
                    ...
                    _conn = Nothing
                End If
                If _conn Is Nothing Then _conn = KioskDB.GetConnection(connectionString)
                If _conn IsNot Nothing Then
                    _trans = _conn.BeginTransaction(System.Data.IsolationLevel.ReadCommitted)
                Else
                    ret = False
