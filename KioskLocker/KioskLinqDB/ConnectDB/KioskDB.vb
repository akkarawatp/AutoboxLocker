...
#Region "Connect With ini"
        ...
        Public Shared ReadOnly Property DBServerName() As String
            Get
                ...
                Return ini.ReadString("LockerServerName")
            End Get
        End Property
        Public Shared ReadOnly Property DBDatabaseName() As String
            Get
                Dim ini As IniReader = INIFileName
                Return ini.ReadString("LockerDbName")
            End Get
        End Property
        ...
        Public Shared ReadOnly Property DBDbUserID() As String
            Get
                Dim ini As IniReader = INIFileName
                Return ini.ReadString("LockerDbUserID")
            End Get
        End Property
        ...
        Public Shared ReadOnly Property DBDbPwd() As String
            Get
                Dim ini As IniReader = INIFileName
                Return ini.ReadString("LockerDbPwd")
                'Return DeCripPwd(ini.ReadString("DRRDbPwd"))
            End Get
        End Property
        ...
        Protected Shared ReadOnly Property GetConnectionString() As String
            Get
                Try
                    ...
                    'Return "Data Source=" & DBServerName & ";Initial Catalog=" & DBDatabaseName & ";User ID=" & DBDbUserID & ";Password=" & DBDbPwd & ";Integrated Security=True;Trusted_connection=Yes;"

                    'Return "Data Source=" & DBServerName & ";Initial Catalog=" & DBDatabaseName & ";Integrated Security=True;Trusted_Connection=True;Connect Timeout=1;"
...
#Region "Set Parameter "
        ...
        End Function
        Public Shared Function SetText(ParameterName As String, ParameterValue As Object) As SqlParameter
            Return SetParameter(ParameterName, SqlDbType.VarChar, ParameterValue)
        End Function

        Public Shared Function SetNVarchar(ParameterName As String, ParameterValue As Object) As SqlParameter
            Return SetParameter(ParameterName, SqlDbType.NVarChar, ParameterValue)
        End Function
        ...
        Public Shared Function SetImage(ParameterName As String, ParameterValue As Object) As SqlParameter
            Return SetParameter(ParameterName, SqlDbType.Image, ParameterValue)
        End Function

        Public Shared Function SetImage(ParameterName As String, ParameterValue As Byte()) As SqlParameter
            Return SetParameter(ParameterName, SqlDbType.Image, ParameterValue)
        End Function
#End Region
...
#Region " Encrypt/Decrypt "
        Private Shared EncryptionKey As String = "DRR_Encrypt2016"
