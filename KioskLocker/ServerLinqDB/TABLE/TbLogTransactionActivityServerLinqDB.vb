...
Namespace TABLE
    'Represents a transaction for TB_LOG_TRANSACTION_ACTIVITY table ServerLinqDB.
    '[Create by  on October, 20 2016]
    Public Class TbLogTransactionActivityServerLinqDB
        Public sub TbLogTransactionActivityServerLinqDB()
       ...
       'Define Public Method 
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbLogTransactionActivityServerLinqDB
            Dim p(1) As SQLParameter
            p(0) = DB.SetBigInt("@_ID", cID)
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction, cmdPara() As SQLParameter) As TbLogTransactionActivityServerLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (CREATED_BY, CREATED_DATE, MS_KIOSK_ID, TRANS_DATE, DEPOSIT_TRANS_NO, PICKUP_TRANS_NO, STAFF_CONSOLE_TRANS_NO, MS_APP_SCREEN_ID, MS_APP_STEP_ID, LOG_DESC, IS_PROBLEM, SYNC_TO_SERVER)"
