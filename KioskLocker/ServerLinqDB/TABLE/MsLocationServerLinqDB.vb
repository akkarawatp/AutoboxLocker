...
Namespace TABLE
    ...
    Public Class MsLocationServerLinqDB
        ...
        End Sub 
        ' MS_LOCATION
        Const _tableName As String = "MS_LOCATION"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into MS_LOCATION table successfully.
        ...
        '/// Returns an indication whether the current data is updated to MS_LOCATION table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from MS_LOCATION table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of MS_LOCATION by specified ID key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of MS_LOCATION by specified ID key is retrieved successfully.
        '/// <param name=cID>The ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As MsLocationServerLinqDB
            Dim p(1) As SQLParameter
            p(0) = DB.SetBigInt("@_ID", cID)
        ...
        '/// Returns an indication whether the record of MS_LOCATION by specified LOCATION_CODE key is retrieved successfully.
        ...
        Public Function ChkDataByLOCATION_CODE(cLOCATION_CODE As String, trans As SQLTransaction) As Boolean
            ...
            cmdPara(0) = DB.SetText("@_LOCATION_CODE", cLOCATION_CODE) 
            Return doChkData("LOCATION_CODE = @_LOCATION_CODE", trans, cmdPara)
        End Function

        '/// Returns an duplicate data record of MS_LOCATION by specified LOCATION_CODE key is retrieved successfully.
        '/// <param name=cLOCATION_CODE>The LOCATION_CODE key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByLOCATION_CODE(cLOCATION_CODE As String, cID As Long, trans As SQLTransaction) As Boolean
            ...
            Return doChkData("LOCATION_CODE = @_LOCATION_CODE And ID <> @_ID", trans, cmdPara)
        End Function


        '/// Returns an indication whether the record of MS_LOCATION by specified LOCATION_NAME key is retrieved successfully.
        '/// <param name=cLOCATION_NAME>The LOCATION_NAME key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByLOCATION_NAME(cLOCATION_NAME As String, trans As SQLTransaction) As Boolean
            Dim cmdPara(2)  As SQLParameter
            cmdPara(0) = DB.SetText("@_LOCATION_NAME", cLOCATION_NAME) 
            Return doChkData("LOCATION_NAME = @_LOCATION_NAME", trans, cmdPara)
        End Function

        '/// Returns an duplicate data record of MS_LOCATION by specified LOCATION_NAME key is retrieved successfully.
        '/// <param name=cLOCATION_NAME>The LOCATION_NAME key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByLOCATION_NAME(cLOCATION_NAME As String, cID As Long, trans As SQLTransaction) As Boolean
            Dim cmdPara(2)  As SQLParameter
            cmdPara(0) = DB.SetText("@_LOCATION_NAME", cLOCATION_NAME) 
            cmdPara(1) = DB.SetBigInt("@_ID", cID) 
            Return doChkData("LOCATION_NAME = @_LOCATION_NAME And ID <> @_ID", trans, cmdPara)
        End Function


        '/// Returns an indication whether the record of MS_LOCATION by specified condition is retrieved successfully.
        ...
        Private Function SetParameterData() As SqlParameter()
            ...
            cmbParam(5) = New SqlParameter("@_LOCATION_CODE", SqlDbType.VarChar)
            cmbParam(5).Value = _LOCATION_CODE
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction, cmdPara() As SQLParameter) As MsLocationServerLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table MS_LOCATION
        ...
        'Get update statement form table MS_LOCATION
        ...
        'Get Delete Record in table MS_LOCATION
