...
Namespace TABLE
    'Represents a transaction for MS_APP_STEP table ServerLinqDB.
    '[Create by  on November, 17 2017]
    Public Class MsAppStepServerLinqDB
        Public sub MsAppStepServerLinqDB()
       ...
       'Define Public Method 
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As MsAppStepServerLinqDB
            Dim p(1) As SQLParameter
            p(0) = DB.SetBigInt("@_ID", cID)
        ...
        '/// Returns an indication whether the record of MS_APP_STEP by specified APP_STEP_CODE key is retrieved successfully.
        '/// <param name=cAPP_STEP_CODE>The APP_STEP_CODE key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByAPP_STEP_CODE(cAPP_STEP_CODE As String, trans As SQLTransaction) As Boolean
            Dim cmdPara(2)  As SQLParameter
            cmdPara(0) = DB.SetText("@_APP_STEP_CODE", cAPP_STEP_CODE) 
            Return doChkData("APP_STEP_CODE = @_APP_STEP_CODE", trans, cmdPara)
        End Function

        '/// Returns an duplicate data record of MS_APP_STEP by specified APP_STEP_CODE key is retrieved successfully.
        '/// <param name=cAPP_STEP_CODE>The APP_STEP_CODE key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByAPP_STEP_CODE(cAPP_STEP_CODE As String, cID As Long, trans As SQLTransaction) As Boolean
            Dim cmdPara(2)  As SQLParameter
            cmdPara(0) = DB.SetText("@_APP_STEP_CODE", cAPP_STEP_CODE) 
            cmdPara(1) = DB.SetBigInt("@_ID", cID) 
            Return doChkData("APP_STEP_CODE = @_APP_STEP_CODE And ID <> @_ID", trans, cmdPara)
        End Function
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction, cmdPara() As SQLParameter) As MsAppStepServerLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
