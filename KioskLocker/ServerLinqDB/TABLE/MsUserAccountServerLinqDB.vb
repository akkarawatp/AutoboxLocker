...
Namespace TABLE
    'Represents a transaction for MS_USER_ACCOUNT table ServerLinqDB.
    '[Create by  on November, 17 2017]
    Public Class MsUserAccountServerLinqDB
        Public sub MsUserAccountServerLinqDB()

        End Sub 
        ' MS_USER_ACCOUNT
        Const _tableName As String = "MS_USER_ACCOUNT"
        ...
        Dim _FORCE_CHANGE_PWD As Char = "N"
        ...
        Public Property UPDATED_DATE() As  System.Nullable(Of DateTime) 
            ...
            End Set
        End Property 
        <Column(Storage:="_ACCOUNT_NO", DbType:="VarChar(50) NOT NULL ",CanBeNull:=false)>  _
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into MS_USER_ACCOUNT table successfully.
        ...
        '/// Returns an indication whether the current data is updated to MS_USER_ACCOUNT table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from MS_USER_ACCOUNT table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of MS_USER_ACCOUNT by specified ID key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of MS_USER_ACCOUNT by specified ID key is retrieved successfully.
        '/// <param name=cID>The ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As MsUserAccountServerLinqDB
            Dim p(1) As SQLParameter
            p(0) = DB.SetBigInt("@_ID", cID)
        ...
        '/// Returns an indication whether the record of MS_USER_ACCOUNT by specified ACCOUNT_NO key is retrieved successfully.
        ...
        Public Function ChkDataByACCOUNT_NO(cACCOUNT_NO As String, trans As SQLTransaction) As Boolean
            ...
            cmdPara(0) = DB.SetText("@_ACCOUNT_NO", cACCOUNT_NO) 
            Return doChkData("ACCOUNT_NO = @_ACCOUNT_NO", trans, cmdPara)
        End Function

        '/// Returns an duplicate data record of MS_USER_ACCOUNT by specified ACCOUNT_NO key is retrieved successfully.
        '/// <param name=cACCOUNT_NO>The ACCOUNT_NO key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByACCOUNT_NO(cACCOUNT_NO As String, cID As Long, trans As SQLTransaction) As Boolean
            ...
            Return doChkData("ACCOUNT_NO = @_ACCOUNT_NO And ID <> @_ID", trans, cmdPara)
        End Function


        '/// Returns an indication whether the record of MS_USER_ACCOUNT by specified USERNAME key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of MS_USER_ACCOUNT by specified USERNAME key is retrieved successfully.
        '/// <param name=cUSERNAME>The USERNAME key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of MS_USER_ACCOUNT by specified condition is retrieved successfully.
        ...
        Private Function SetParameterData() As SqlParameter()
            ...
            cmbParam(5) = New SqlParameter("@_ACCOUNT_NO", SqlDbType.VarChar)
            cmbParam(5).Value = _ACCOUNT_NO

            cmbParam(6) = New SqlParameter("@_FIRST_NAME", SqlDbType.VarChar)
            cmbParam(6).Value = _FIRST_NAME

            cmbParam(7) = New SqlParameter("@_LAST_NAME", SqlDbType.VarChar)
            cmbParam(7).Value = _LAST_NAME
            ...
            cmbParam(10) = New SqlParameter("@_MOBILE_NO", SqlDbType.VarChar)
            If _MOBILE_NO.Trim <> "" Then 
                cmbParam(10).Value = _MOBILE_NO
            Else
                cmbParam(10).Value = DBNull.value
            End If

            cmbParam(11) = New SqlParameter("@_USERNAME", SqlDbType.VarChar)
            cmbParam(11).Value = _USERNAME

            cmbParam(12) = New SqlParameter("@_PASSWD", SqlDbType.VarChar)
            cmbParam(12).Value = _PASSWD

            cmbParam(13) = New SqlParameter("@_FORCE_CHANGE_PWD", SqlDbType.Char)
            cmbParam(13).Value = _FORCE_CHANGE_PWD
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction, cmdPara() As SQLParameter) As MsUserAccountServerLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table MS_USER_ACCOUNT
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (CREATED_BY, CREATED_DATE, ACCOUNT_NO, FIRST_NAME, LAST_NAME, COMPANY_NAME, EMAIL, MOBILE_NO, USERNAME, PASSWD, FORCE_CHANGE_PWD, ACTIVE_STATUS)"
                Sql += " OUTPUT INSERTED.ID, INSERTED.CREATED_BY, INSERTED.CREATED_DATE, INSERTED.UPDATED_BY, INSERTED.UPDATED_DATE, INSERTED.ACCOUNT_NO, INSERTED.FIRST_NAME, INSERTED.LAST_NAME, INSERTED.COMPANY_NAME, INSERTED.EMAIL, INSERTED.MOBILE_NO, INSERTED.USERNAME, INSERTED.PASSWD, INSERTED.FORCE_CHANGE_PWD, INSERTED.ACTIVE_STATUS"
                Sql += " VALUES("
                sql += "@_CREATED_BY" & ", "
                sql += "@_CREATED_DATE" & ", "
                sql += "@_ACCOUNT_NO" & ", "
        ...
        'Get update statement form table MS_USER_ACCOUNT
        ...
        'Get Delete Record in table MS_USER_ACCOUNT
        ...
        'Get Select Statement for table MS_USER_ACCOUNT
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATED_BY, CREATED_DATE, UPDATED_BY, UPDATED_DATE, ACCOUNT_NO, FIRST_NAME, LAST_NAME, COMPANY_NAME, EMAIL, MOBILE_NO, USERNAME, PASSWD, FORCE_CHANGE_PWD, ACTIVE_STATUS FROM " & tableName
                Return Sql
            End Get
        End Property
